...
public class ControlMappings {
    ...
    public static int SHIFT_DRIVE_HIGH_BTN = 5;
    public static int GEAR_SLIDER_UP_BTN = 2;
    public static int GEAR_SLIDER_DOWN_BTN = 3;
    public static int GEAR_SLIDER_STICK = 4;
    public static int ELEVATOR_UP_BTN = 5;
    public static int ELEVATOR_DOWN_BTN = 6;

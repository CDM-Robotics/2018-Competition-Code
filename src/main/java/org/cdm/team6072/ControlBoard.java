...
public class ControlBoard {
    ...
    private ControlBoard () {
        ...
        gamepadButtons[ControlMappings.CLIMB_BTN] = new JoystickButton(usb0_stick, ControlMappings.CLIMB_BTN);
        gamepadButtons[ControlMappings.CLIMB_BTN].whenActive(Elevator.getInstance().moveUp());

        gamepadButtons[ControlMappings.GEAR_SLIDER_DOWN_BTN] = new JoystickButton(usb0_stick, ControlMappings.GEAR_SLIDER_DOWN_BTN);
        gamepadButtons[ControlMappings.GEAR_SLIDER_DOWN_BTN].whenActive(Elevator.getInstance().moveDown());

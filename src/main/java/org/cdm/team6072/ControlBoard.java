...
public class ControlBoard {
    ...
    private ControlBoard () {
        ...
        usb0_buttons[ControlMappings.GRABBER_WHEELS_IN_BTN] = new JoystickButton(usb0_stick, ControlMappings.GRABBER_WHEELS_IN_BTN);
        usb0_buttons[ControlMappings.GRABBER_WHEELS_IN_BTN].whenPressed(new RunGrabberWheelsCmd(Grabber.WheelDirn.In));
        usb0_buttons[ControlMappings.GRABBER_WHEELS_IN_BTN].whenReleased(new StopGrabberWheelsCmd());

        usb0_buttons[ControlMappings.GRABBER_WHEELS_OUT_BTN] = new JoystickButton(usb0_stick, ControlMappings.GRABBER_WHEELS_OUT_BTN);
        usb0_buttons[ControlMappings.GRABBER_WHEELS_OUT_BTN].whenPressed(new RunGrabberWheelsCmd(Grabber.WheelDirn.Out));
        usb0_buttons[ControlMappings.GRABBER_WHEELS_OUT_BTN].whenReleased(new StopGrabberWheelsCmd());
